          ...
          sidebarPanel(width="100%",
            ...
            fluidRow(
              column(width=6,
                ...
                div(actionButton("initializeGraph", "Query"), style="display:inline-block;vertical-align:top;margin-left:35px; margin-top:20px")
              )
            )
          )
        )
      ...
      fluidRow(
        column(width=5,
          ...
          sidebarPanel(width="100%",
            ...
            fluidRow(
              column(width=12,
                checkboxGroupInput("UCDProxDist", "UCDProxDist",
            ...
            fluidRow(
              column(width=12,
                checkboxGroupInput("UCDDx", "UCDDx",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T))
            ...
            fluidRow(
              column(width=12,
                checkboxGroupInput("Age", "Age (1, 10, 100, 1,000 day(s))",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T))
            ...
            fluidRow(
              column(width=12,
                checkboxGroupInput("HASxLast", "HASxLast",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T))
        ...
        column(width=5,
          ...
          sidebarPanel(width="100%",
            ...
            fluidRow(
              column(width=12,
                checkboxGroupInput("conceptFSN", "SNOMEDCT concept",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T))
            ...
            fluidRow(
              column(width=12,
                checkboxGroupInput("FindingSite", "Finding site",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T))
      ...
      fluidRow(
        ...
        column(width=5,
          sidebarPanel(width="100%",
            ...
            fluidRow(
              column(width=12,
                checkboxGroupInput("interact1", "Interaction set 1",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T),
                checkboxGroupInput("interact2", "Interaction set 2",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T)
              )
        ...
        column(width=5,
          sidebarPanel(width="100%",
            ...
            fluidRow(
              column(width=12,
                checkboxGroupInput("interact3", "Interaction set 3",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T),
                checkboxGroupInput("interact4", "Interaction set 4",
                  choiceNames=c("UCDProxDist", "Sex", "UCDDx", "Age", "HASxLast", "Concept", "Rx", "FndSt"),
                  choiceValues=c("UCDProxDist", "Sex", "UCDDx", "onsetAgeDays", "HASxLast", "conceptFSN", "Rx", "findingSiteFSN"),
                  inline=T)
              )
