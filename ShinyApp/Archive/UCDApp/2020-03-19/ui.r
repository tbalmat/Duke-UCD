        ...
        column(width=3,
          ...
          sidebarPanel(width="100%",
            ...
            radioButtons("nodeVar", "Participant node variable",
                         choiceNames=c("UCDProx", "Sex", "UCDDx", "Age"),
                         choiceValues=c("UCDProx", "Sex", "UCDDx", "onsetAgeDays"),
                         selected="UCDProx", inline=T),
            radioButtons("prescripConnector", "Include prescriptions, attached to",
                         choiceNames=c("None", "Concept", "Partic node var"),
                         choiceValues=c("none", "concept", "nodeVar"), inline=T),
            checkboxInput("prescripSubsume", "Subsume prescription", value=F),
          ...
          sidebarPanel(width="100%",
            ...
            sliderInput("vMassFactor", "Vertex mass factor", min=0, max=2, value=1, step=0.1),
